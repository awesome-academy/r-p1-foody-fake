...
ActiveRecord::Schema.define(version: 2019_05_20_102430) do
  ...
  create_table "district", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "districtid", limit: 20, null: false
    t.string "name", limit: 191, null: false
    t.string "provinceid", limit: 20, null: false
  end
  ...
  create_table "province", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "provinceid", limit: 20, null: false
    t.string "name", limit: 191, null: false
  end
  ...
  create_table "ward", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "wardid", limit: 20, null: false
    t.string "name", limit: 191, null: false
    t.string "districtid", limit: 20, null: false
  end
